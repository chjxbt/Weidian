...
class SActivity(SBase):
    ...
    def get_activity_all(self):
        """所有活动"""
        activity_list = self.session.query(Activity.ACid, Activity.GOid, Activity.ACtype, Activity.TopnavId,
                                           Activity.ACtext,
    ...
    def get_activity_by_topnavid(self, navid):
        ...
        print acvitity_list
        acvitity_list = [ActivityNameTuple(*tuple(acv_list), user=[], media=[], stags=[], foward_num=0) for acv_list in acvitity_list]
    ...
    def get_lasting_activity_by_topnavid(self, navid):
        ...
        acvitity_list = [ActivityNameTuple(*tuple(acv_list)) for acv_list in all_lasting_activity]
        return acvitity_list
