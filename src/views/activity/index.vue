    ...
    <div class="m-weidian-content">
      ...
      <div class="content-table">
        <el-table :data="levelList" border style="width: 100%" v-loading="levelLoading">
          <el-table-column prop="name" label="任务等级" width="260"></el-table-column>
          <el-table-column prop="content" label="奖励方式" width="500"></el-table-column>
      ...
      <div class="input-box">
        ...
        <div class="box-right">
          <el-input v-model="discountsName" style="width: 2rem" size="small" placeholder="请输入优惠门槛"></el-input>
        </div>
      ...
      <div class="input-box">
        ...
        <div class="box-right">
          <el-select v-model="type" placeholder="请选择优惠类型" style="width: 2rem" size="mini">
      ...
      <div class="input-box">
        <div class="box-text">使用渠道</div>
        <div class="box-right">
          <el-select v-model="useMethod" placeholder="请选择优惠类型" style="width: 2rem" size="mini">
            <el-option v-for="item in useMethodList" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
        </div>
      </div>
      <div class="input-box">
        ...
        <div class="box-right">
          <el-select v-model="giveToOne" placeholder="请选择优惠类型" style="width: 2rem" size="mini">
            <el-option v-for="item in giveToOneList" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
        </div>
      </div>
      <div class="input-box" v-if="type != 2">
        ...
        <div class="box-right">
          <el-input v-model="amount" style="width: 2rem" size="small" placeholder="请输入优惠金额"></el-input>
        </div>
        <div class="box-text">元</div>
      </div>
      <div class="input-box" v-if="type == 2">
        ...
        <div class="box-right">
          <el-select v-model="bonus" placeholder="请选择佣金加成比率" style="width: 2rem" size="mini">
      ...
      <div class="input-box" v-if="type != 3">
        ...
        <div class="box-right">
          <el-input v-model="threshold" style="width: 2rem" size="small" placeholder="请输入优惠门槛"></el-input>
        </div>
        <div class="box-text">元</div>
      </div>
      <div class="input-box">
