<template>
  <div class="m-apply-withdrawal">
    <div class="m-amount">
      <div class="m-ft-30">提现金额</div>
      <div class="m-input-amount">
        <p class="m-border">
          <span class="m-ft-50 m-red m-ft-b">￥</span>
          <input v-model="money" placeholder="最大可提现X元" class="m-input-amount-input">
          <span class="m-close-icon" @click="clearMoney"></span>
        </p>
        <p>
          <input type="text" readonly="readonly" placeholder="可用余额9.01元（仅支持大于10元的提现申请）">
        </p>
      </div>
    </div>
...
<style lang="less" rel="stylesheet/less" scoped>
  ...
  .m-apply-withdrawal {
    ...
    .m-apply-withdrawal-btn {
      margin-top: 60px;
      &.m-apply-withdrawal-btn-two {
