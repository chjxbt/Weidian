<template>
  <div class="m-fans" >
    <h3 class="m-fans-title">
      <!--邀请好友成为<span class="m-ft-60">专属粉丝</span>-->
    </h3>
    <div class="m-fans-border">
      <div class="m-fans-border-back">
        <div class="m-fans-img-box">
          <span class="m-fans-img"></span>
          <p class="m-fans-img-text">一次绑定 终生受益</p>
        </div>
        <p class="m-fans-info">每邀请1位专属粉丝预计收益 <span class="m-red m-ft-32">￥154</span> <span @click="detailClick">查看详情 ></span></p>
        <!--<p class="m-fans-code-box">我的邀请码：<span class="m-ft-b m-ft-40"> {{code}}</span> <span class="m-fans-code-copy" @click="copyCode">复制</span></p>-->
      </div>

    </div>
    <div class="m-fans-share-box">
    ...
    <div class="m-fans-ranking-list-name">邀请排行榜</div>
...
<style lang="less" rel="stylesheet/less" scoped>
  ...
  .m-fans{
    ...
    .m-fans-title{
      /*font-size: 50px;*/
      /*font-weight: bold;*/
      /*background:  linear-gradient(to bottom, #f0d9af, #ddab68) ;*/
      /*-webkit-background-clip: text;*/
      /*color: transparent;*/
      /*text-shadow: 8px 8px 5px rgba(0, 0, 0, 0.16);*/
      /*!*margin-bottom: 20px;*!*/
      /*span{*/
      /*font-size: 70px;*/
      /*}*/
      ...
      width: 585px;
      height: 111px;
      background: url("/static/images/fans_name.png") no-repeat;
      background-size: 100% 100%;
    }
    .m-fans-border{
      display: flex;
      ...
      .m-fans-border-back{
        width: 652px;
        height: 530px;
        background: url("/static/images/fans_border.png") no-repeat;
        background-size: 100% 100%;
        margin-top: 20px;
        padding-top: 10px;
        .m-fans-img-box{
          ...
          .m-fans-img{
            ...
            width: 379px;
            height: 340px;
            background: url("/static/images/fans_img.png") no-repeat;
            background-size: 100% 100%;
          }
          .m-fans-img-text{
            position: absolute;
    ...
    .m-fans-ranking-list-name{
      width: 100%;
      height: 90px;
      line-height: 90px;
      font-size: 44px;
      color: #7d3600;
      background: url("/static/images/fans_ranking_list.png") no-repeat;
      background-size: 100% 100%;
      margin: 25px 0;
    }
    .m-fans-ranking-list{
